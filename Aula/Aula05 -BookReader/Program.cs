...
while (current != null){
    ...
    //Coloca no centro de uma linha com 90 caracteres
    ...
    Console.WriteLine();
    Console.WriteLine($"Quote from 'Windows Application Development Cookbook' by Marcin Jamro,{ Environment.NewLine} published by Packt Publishingin 2016.");
    Console.WriteLine();
